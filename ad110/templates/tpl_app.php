        ...
        <div class="mt10 clearfix">
            <div class="l">
               ...
               <!--  <a href="collect.php" class="but2">添加应用</a> -->
				<a href="javascript:void(0);" onClick="show_edit(0);" class="but2" style="color:yellow">添加本地应用</a>
            ...
            <div class="tab_table">
                ...
                <div id="e_box" style="overflow-y:auto;overflow-x:hidden;height:410px;border:1px solid #ddd;zoom:1;position:relative;">
                    <table class="tb3" id="tab001">
                        ...
                        <tr>
                            <td>浏览量：</td>
                            <td  class="alignleft"><input type="text" class="ipt" id="app_visitors" name="app_visitors"  value="100"/></td>
                            <td>评论量：</td>
                            <td  class="alignleft"><input type="text" class="ipt" id="app_comments" name="app_comments"  value="10"/></td>

                        </tr>
                        <tr>
                            <td>推荐星级：</td>
                            <td  class="alignleft" colspan="3"><input type="text" class="ipt" id="app_recomment" name="app_recomment"  value="8.0"/>
