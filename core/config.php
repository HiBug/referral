...
define("AUTH_CODE", "ExcJegbnje9RGI7e3TC8Yv8xmvSIGxxd3xYJZOT5jno7b"); // 授权码
 ...
 * 以下参数为可后台编辑
 */
define("SITE_NAME", "慧赚网"); //站点名称
define("SITE_URL", "http://www.huizhuan.online/"); //站点域名
define("SITE_LOGO", "/upload/img/2018/09/25/5ba9e8889fe3c.png"); //站点LOGO
...
define("UPLOAD_CODE", "x9xYBP"); //上传安全码，该值安装时候自动生成，6-12位随机字母（大小写）数字，特殊符号
define("UPLOAD_KEY", "-KH5YU"); //上传密钥，该值安装时候自动生成，6-12位随机字母（大小写）数字，特殊符号
define("COMMENT_CODE", ""); //评论代码
define("APP_IMG_LOCAL", "0"); //添加应用是否图片本地化
define("CONTENT_NLINK", "0"); //是否开启正文内链
define("COUNT_CODE", ""); //统计代码
define("SEO_TITLE", "慧赚网"); //首页SEO标题
define("SEO_KEYWORDS", "手赚|网上赚钱|手机锁屏|免费红包|手赚APP|安卓苹果软件"); //首页关键词
define("SEO_DESCRIPTION", ""); //首页描述
define("CONTENT_MOBILE", "1"); //是否开启手机版
define("WAP_URL", "http://www.huizhuan.online/"); //手机版独立域名
define("WAP_LOGO", "/upload/img/2018/09/25/5ba9e84e67f45.png"); //手机版图片
