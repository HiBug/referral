...
<title><?php echo $c->categories[$cid]['cname'].'试玩app赚钱排行_安卓手机试玩赚钱任务平台 - '.SITE_NAME;?></title>
...
<div class="box app-infos">
					<div class="box info-tab" id="info-tab">
						<a href="javascript:;" id="item-1" class="t-sel" onclick ="tab_info('item-1')">最新</a>
						<a href="javascript:;" id="item-2" onclick="tab_info('item-2')">推荐</a>
							</div>
