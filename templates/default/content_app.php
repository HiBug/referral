            ...
            <div class="l body-left"> <!-- 左侧主体内容 -->
                <div class="bor-sty bg-fff bout-content app-info">
                    <div class="code-right">
                        <?php error_reporting( E_ALL&~E_NOTICE );// echo $c->google_qrcode(urlencode(SITE_URL.SITE_PATH.'download.php?hid='.$con['history'][0]['appcms_history_id']),"140");
...
?>
                    ...
                    <div class="app-info-i">
                        ...
                        <div class="detailed-info">
							...
							<span>适合系统：<?php echo $con['app_system']; ?></span>
                        </div>
                    </div>
					<style>
					.down-install a.down-computer {
						background: #3ab6f9 none repeat scroll 0 0;
						display: block;
						margin: 0 auto 20px;
						text-align: center;
						width: 60%;
    ...
    background: #3ab6f9 none repeat scroll 0 0;
                    ...
                    <div class="down-install">
                        <a href="javascript:void(0);" onclick="window.open('<?php echo(SITE_PATH.'download.php?id='.$con['history'][0]['appcms_history_id']);?>');" class="down-computer">免费下载</a>&nbsp;&nbsp;
